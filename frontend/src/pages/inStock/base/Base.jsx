  ...
  return (
    <>
                ...
                {Base && Base?.data?.length > 0 ? (
                  Base?.data?.map((data, index) => (
                    ...
                    >
                      ...
                      <td className="px-6 py-4">{data.TYm} m</td>
      ...
      {isOpen && (
        ...
        >
          <div className="relative py-4 px-3 w-full max-w-4xl max-h-[80vh] scrollable-content bg-white rounded-md shadow dark:bg-gray-700 overflow-y-auto">
            {/* ------------- HEADER ------------- */}
