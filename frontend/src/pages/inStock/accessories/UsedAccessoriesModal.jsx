                        ...
                        <div className="p-4 md:p-5">
                            <form onSubmit={handleSubmit}>
                                ...
                                <div className="flex justify-center mt-6">
                                    {UsedAccessoriesLoading ? (
                                        <button disabled type="button" className="text-white cursor-not-allowed border-gray-300 bg-gray-600 focus:ring-0 focus:outline-none focus:ring-blue-300 font-medium rounded text-sm px-5 py-3 text-center mr-2 dark:bg-blue-600 dark:hover:bg-blue-700  inline-flex items-center">
...
export default UsedAccessoriesModal;
