...
const BagBoxTable = () => {
    ...
    useEffect(() => {
        dispatch(getAllPurchasingHistoryAsync({ category: 'Bag/box', search, page }))
            ...
            paginationLinks.push(
                <li key={i} onClick={ToDown}>
                    <Link
                        ...
                        onClick={() => dispatch(getAllPurchasingHistoryAsync({ category: 'Bag/box', search, page: i }))}
                    >
                        {i}
                    </Link>
                </li>
