                    ...
                    BuyersChecks?.checkDetails
                      ...
                      .map((data, index, arr) => (
                        <React.Fragment>
                          ...
                          >
                            <th className="px-6 py-4 font-medium text-sm" scope="row">
                            {data?.newCheck && <span className="bg-red-500 mr-2 rounded-md text-white p-1">New</span>}
                              {data?.date}
                            </th>
                            ...
                            <td className="pl-10 py-4 flex items-center gap-4">
                              {!data.updated ? (
                                data.paid ? (
                                  ...
                                  <>
                                    <button
                                      onClick={() => openModal({id:data?.id,category:"UpdateCheck"})}
                                ...
                                <div className="text-center  w-full text-blue-700">Updated</div>
