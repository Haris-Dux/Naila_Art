              ...
              <form onSubmit={handleSubmit} className="space-y-4 md:space-y-6">
                ...
                {ForgetPassloading ? (
                  <button
                    disabled
                    type="button"
                    className="text-white cursor-not-allowed bg-gray-500  font-medium rounded text-sm px-5 py-2.5 text-center mx-auto flex items-center justify-center w-full"
                  >
                    <svg
                      aria-hidden="true"
                      role="status"
